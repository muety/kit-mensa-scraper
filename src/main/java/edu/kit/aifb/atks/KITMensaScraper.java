...
public class KITMensaScraper {
    ...
    /**
     * Serialize a list of meals to a JSON string.
     * @param meals List of meal to marshal.
     * @return JSON string.
     */
    ...
    /**
     * Deserialize a list of mensa meals from a JSON string.
     * @param json JSON string.
     * @return List of {@link MensaMeal} items.
     */
